              ...
              >
                ...
                <div className="col-span-1 lg:col-span-3 flex justify-center items-center gap-2">
                  <button 
                    ...
                    title={userRole === 'admin' ? "แก้ไข" : "อัปเดตสถานะ"}
                  >
                    <Edit2 size={16} />
                  </button>
                  {userRole === 'admin' && (
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full text-sm border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-3 py-2 border disabled:bg-slate-100 disabled:text-slate-500"
