...
const SummaryCard: React.FC<SummaryCardProps> = ({ 
  ...
  const themes: Record<SummaryCardColor, {
    ...
    indigo: { 
      ...
      bgGradient: 'from-white to-indigo-50/40', shadow: 'shadow-indigo-500/10'
    },
    emerald: { 
      ...
      bgGradient: 'from-white to-emerald-50/40', shadow: 'shadow-emerald-500/10'
    },
    rose: { 
      ...
      bgGradient: 'from-white to-rose-50/40', shadow: 'shadow-rose-500/10'
    },
    amber: { 
      text: 'text-amber-600', border: 'border-amber-100', accent: 'bg-amber-500',
      hover: 'hover:border-amber-300 hover:shadow-amber-500/25', iconBg: 'bg-amber-100/80',
      bgGradient: 'from-white to-amber-50/40', shadow: 'shadow-amber-500/10'
    },
    violet: { 
      ...
      bgGradient: 'from-white to-violet-50/40', shadow: 'shadow-violet-500/10'
    },
    fuchsia: { 
      ...
      bgGradient: 'from-white to-fuchsia-50/40', shadow: 'shadow-fuchsia-500/10'
    },
    sky: { 
      text: 'text-sky-600', border: 'border-sky-100', accent: 'bg-sky-500',
      hover: 'hover:border-sky-300 hover:shadow-sky-500/25', iconBg: 'bg-sky-100/80',
      bgGradient: 'from-white to-sky-50/40', shadow: 'shadow-sky-500/10'
    },
    teal: { 
      ...
      bgGradient: 'from-white to-teal-50/40', shadow: 'shadow-teal-500/10'
    },
    orange: { 
      text: 'text-orange-600', border: 'border-orange-100', accent: 'bg-orange-500',
      hover: 'hover:border-orange-300 hover:shadow-orange-500/25', iconBg: 'bg-orange-100/80',
      bgGradient: 'from-white to-orange-50/40', shadow: 'shadow-orange-500/10'
    },
    blue: { 
      ...
      bgGradient: 'from-white to-blue-50/40', shadow: 'shadow-blue-500/10'
    },
    cyan: { 
      text: 'text-cyan-600', border: 'border-cyan-100', accent: 'bg-cyan-500',
      hover: 'hover:border-cyan-300 hover:shadow-cyan-500/25', iconBg: 'bg-cyan-100/80',
      bgGradient: 'from-white to-cyan-50/40', shadow: 'shadow-cyan-500/10'
    },
    lime: { 
      text: 'text-lime-600', border: 'border-lime-100', accent: 'bg-lime-500',
      hover: 'hover:border-lime-300 hover:shadow-lime-500/25', iconBg: 'bg-lime-100/80',
      bgGradient: 'from-white to-lime-50/40', shadow: 'shadow-lime-500/10'
    },
    pink: { 
      ...
      bgGradient: 'from-white to-pink-50/40', shadow: 'shadow-pink-500/10'
    },
    purple: { 
      ...
      bgGradient: 'from-white to-purple-50/40', shadow: 'shadow-purple-500/10'
    },
    yellow: { 
      text: 'text-yellow-600', border: 'border-yellow-100', accent: 'bg-yellow-500',
      hover: 'hover:border-yellow-300 hover:shadow-yellow-500/25', iconBg: 'bg-yellow-100/80',
      bgGradient: 'from-white to-yellow-50/40', shadow: 'shadow-yellow-500/10'
    },
    red: { 
      ...
      bgGradient: 'from-white to-red-50/40', shadow: 'shadow-red-500/10'
    },
    green: { 
      ...
      bgGradient: 'from-white to-green-50/40', shadow: 'shadow-green-500/10'
    },
    slate: { 
      ...
      bgGradient: 'from-white to-slate-50/40', shadow: 'shadow-slate-500/10'
    },
    zinc: { 
      ...
      bgGradient: 'from-white to-zinc-50/40', shadow: 'shadow-zinc-500/10'
    },
    stone: { 
      ...
      bgGradient: 'from-white to-stone-50/40', shadow: 'shadow-stone-500/10'
    }
  };
  ...
  return (
    <div 
      className={`relative bg-gradient-to-br ${currentTheme.bgGradient} rounded-2xl p-6 border-2 transition-all duration-500 overflow-hidden flex flex-col justify-between h-full ${currentTheme.border} ${currentTheme.shadow} ${isInteractive ? 'cursor-pointer active:scale-95 focus:ring-4 focus:ring-indigo-500/20 outline-none' : 'cursor-default'} ${currentTheme.hover} hover:-translate-y-2 group shadow-lg`}
      onClick={onClick}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-xs font-black text-slate-500 uppercase tracking-[0.15em] mt-2 group-hover:text-slate-600 transition-colors">
          {title}
        </p>
        
        {subtext && (
          <div className="mt-4 pt-4 border-t border-slate-100/60">
            <p className="text-[11px] font-bold text-slate-500 leading-relaxed italic group-hover:text-slate-600 transition-colors">
              {subtext}
            </p>
          </div>
        )}
